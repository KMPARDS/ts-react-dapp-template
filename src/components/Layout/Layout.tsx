...
// this is layout, which is intended to be used in all pages, (can be exceptions)
// Do read the README.md if you haven't
// you can modify the style/layout as you want obviously
